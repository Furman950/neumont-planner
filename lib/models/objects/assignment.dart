...
List<Assignment> assignmentsFromJson(String str) => new List<Assignment>.from(
    json.decode(str).map((x) => Assignment.fromJson(x)));

String assignmentsToJson(List<Assignment> data) =>
